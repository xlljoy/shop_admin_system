...
public enum LocalAccountStateEnum {
	...
	private LocalAccountStateEnum(int state, String stateInfo) {
		this.state = state;
		this.stateInfo = stateInfo;
	}
	
	public static LocalAccountStateEnum stateOf(int state) {
		for (LocalAccountStateEnum stateEnum : values()) {
