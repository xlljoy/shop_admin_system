...
// use redis for less frequent changed data, here, like : zone, daylyNews, shopCategory
// for example: zone -->
// from serviceImpl: 1. go redis to get data
//                   2. if did not get data, go dataBase to get data and update it to redis
public class JedisUtil {
	public Keys KEYS;
		...
		/** 对存储结构为String类型的操作 */
		// could hold any types: JPEG, JSON ect, mix 512M
		...
		public void setJedisPool(JedisPoolWrapper JedisPoolWrapper) {
			this.jedisPool = JedisPoolWrapper.getJedisPool();
		}
